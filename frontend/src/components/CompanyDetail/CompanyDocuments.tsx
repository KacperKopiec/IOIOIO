...
import {
    useArchiveCompanyDocument,
    useCompanyDocuments,
    useCreateCompanyDocument,
    useDeleteCompanyDocument,
    useUnarchiveCompanyDocument,
...
const CompanyDocuments: React.FC<CompanyDocumentsProps> = ({
    ...
    const documentsQuery = useCompanyDocuments(companyId, showArchived);
    ...
    const createDoc = useCreateCompanyDocument(companyId, userId);
    const uploadDoc = useUploadCompanyDocument(companyId, userId);
    const deleteDoc = useDeleteCompanyDocument(companyId);
    const archiveDoc = useArchiveCompanyDocument(companyId);
    const unarchiveDoc = useUnarchiveCompanyDocument(companyId);
